...
public class imashadap2 extends RecyclerView.Adapter<imashadap2.ImageViewHolder> {

    // Lista de imágenes
    private final int[] images = {
            R.drawable.imagen_37, R.drawable.imagen_75, R.drawable.imagen_78,
            R.drawable.imagen_4, R.drawable.imagen_76, R.drawable.imagen_74, R.drawable.imagen_73, R.drawable.imagen_71, R.drawable.imagen_70,
            R.drawable.imagen_67, R.drawable.imagen_68, R.drawable.imagen_66, R.drawable.imagen_54, R.drawable.imagen_40, R.drawable.imagen_83,
            R.drawable.imagen_82, R.drawable.imagen_86, R.drawable.imagen_81 , R.drawable.imagen_80
    };
    ...
    public ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.itemsh_image, parent, false);
